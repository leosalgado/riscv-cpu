...
datapath: $(BUILD_DIR) $(WAVEFORM_DIR)
	$(IVERILOG) -o $(BUILD_DIR)/$@_tb.vvp $(SRC_DIR)/*.v tb/$@_tb.v
	$(VVP) $(BUILD_DIR)/$@_tb.vvp

all: ula uc registradores memoria_instrucao memoria_dados mux imediato datapath
